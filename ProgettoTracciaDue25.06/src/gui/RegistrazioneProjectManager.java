	...
	private JTextField skills;
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				IlControllore.RegistraProjectManager(CognomePM.getText(), NomePM.getText(), CodiceFiscalePM.getText(), SalarioMedio.getText(), skills.getText());
			}
		});
		btnNewButton.setBounds(270, 200, 103, 39);
		...
		btnNewButton_1_1.setBounds(130, 200, 120, 39);
